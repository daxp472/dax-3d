    ...
    async init()
    {
        ...
        const resourcesPromise = this.resourcesLoader.load(
            [
                ...
                [ 'hellMinionGuard',                       `npcs/gobkit-free/minion-b01.glb${cb}`,                                               'gltf' ],
                [ 'hellMinionKing',                        `npcs/gobkit-free/minion-d01.glb${cb}`,                                               'gltf' ],
                [ 'hellMinionFlyer',                       `npcs/gobkit-free/minion-c01.glb${cb}`,                                               'gltf' ],
