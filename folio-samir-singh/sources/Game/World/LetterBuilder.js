...
export class LetterBuilder
{
    ...
    onClick()
    {
        ...
        if(this.state === LetterBuilder.STATE_REST)
        {
            this.speech.say(
                'Taking a breather',
                "Tired from walking SAMIR SINGH… let me sit. Please don't break it again too fast!",
                4,
                'builder-rest-click'
            )
            return
        ...
        this.speech.say(
            'Letter Builder',
            'Knock SAMIR SINGH letters? I climb down, haul them on my shoulder, and shove them back up!',
            4,
            'builder-info'
        )
    }
    ...
    restSitDown()
    {
        ...
        if(t >= 1)
        {
            ...
            if(!this.sitShown)
            {
                ...
                this.speech.say(
                    'Taking a breather',
                    "Tired from walking SAMIR SINGH… let me sit and rest. Please don't break it again too fast!",
                    4.5,
                    'builder-rest'
                )
            }
